...
@ApiResponse(
        responseCode = "409", description = "Já existe uma agenda com o mesmo nome",
        content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ErrorApiResponse.class),
                examples = @ExampleObject(value = ApiExamples.CALENDAR_ALREADY_EXISTS)))
public @interface ApiCalendarConflict {
}
