...
@ApiResponse(
        responseCode = "409", description = "Reserva já cancelada",
        content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ErrorApiResponse.class),
                examples = @ExampleObject(value = ApiExamples.RESERVATION_ALREADY_CANCELLED)))
public @interface ApiReservationAlreadyCancelled {
}
